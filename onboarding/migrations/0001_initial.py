# Generated by Django 5.1.6 on 2025-04-07 09:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_logged', models.DateField(default=datetime.date(2025, 4, 7))),
                ('time_logged', models.TimeField(default=datetime.time(9, 24, 10, 100238), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry_time', models.DateTimeField(db_comment='When the OTP can no longer be accepted. Default is 5 minutes after when it was created.', default=datetime.datetime(2025, 4, 7, 9, 29, 10, 99797, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datetime_recommended', models.DateTimeField(default=datetime.datetime(2025, 4, 7, 9, 24, 10, 100570, tzinfo=datetime.timezone.utc))),

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_logged', models.DateField(default=datetime.date(2025, 3, 22))),
                ('time_logged', models.TimeField(default=datetime.time(15, 22, 32, 413669), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry_time', models.DateTimeField(db_comment='When the OTP can no longer be accepted. Default is 5 minutes after when it was created.', default=datetime.datetime(2025, 3, 22, 15, 27, 32, 413669, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datetime_recommended', models.DateTimeField(default=datetime.datetime(2025, 3, 22, 15, 22, 32, 414705, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(('user_height__gt', 0)), name='check_user_height_positive'), models.CheckConstraint(condition=models.Q(('user_weight__gt', 0)), name='check_user_weight_positive')],
            },
        ),
    ]

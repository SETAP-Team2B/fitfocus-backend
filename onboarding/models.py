...
class Exercise(models.Model):
    ...
    ex_type = models.CharField(max_length=100, choices=exercise_type, default="", null=False, db_comment="Type of exercise, Cardio, Muscle etc")
    ex_body_area = models.CharField(max_length=15, choices=body_area_choices, default="", null=False, db_comment="What body part the exercise is working on: Legs, back, chest etc")
